...
if voltage == 70:
        if voltage_case == 0:   
                ...
                parameters['rf_voltage'] = 0.070         
                parameters['BLonD_file'] = '../../01_Generate_Longitudinal_Distribution/BLonD_Longitudinal_Distn_TOF_60kV.npz'
        ...
        if voltage_case == 0:   
                ...
                parameters['BLonD_file'] = '../../01_Generate_Longitudinal_Distribution/BLonD_Longitudinal_Distn_TOF_77V.npz'
                parameters['rf_voltage'] = 0.085  
        else: 
                print 'simulation_parameters::Error: Voltage case specified in simulation folder name not allowed'
                exit(0)
